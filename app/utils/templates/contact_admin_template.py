# app/utils/templates/contact_admin_template.py

class ContactAdminEmailTemplate:
    @staticmethod
                            ...
                            <tr>
                                <td align='center' style='padding:40px 20px 20px 20px;'>
                                    ...
                                    <div style='margin:30px 0; padding:20px 25px; background:#FFF5EB; border-left:6px solid #FF6F3C; border-radius:10px; box-shadow:0 3px 8px rgba(255,111,60,0.15); text-align:left;'>
                                        <p style='color:#333; font-size:15px; line-height:1.6; margin:0;'><b>Mesaj:</b></p>
                                        <p style='margin-top:10px; white-space:pre-line;'>{message}</p>
                                    </div>

                                    <p style='font-size:14px; color:#777;'>Sistem otomatik bildirimi.</p>
                                </td>
                            </tr>
                            <tr>
                                <td style='background:#FF6F3C; color:#fff; text-align:center; padding:15px; font-size:12px;'>
                                    © 2025 YuksiApp. Admin Panel Bildirimi.
                                </td>
                            </tr>
                        </table>
                    </td>
