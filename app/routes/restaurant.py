...
#     req: RestaurantRegisterReq,
#     claims: Dict[str, Any] = Depends(auth_controller.require_roles(["Admin"]))
# ):
#     """Restaurant kayıt endpoint - Sadece Admin"""
#     result = await ctrl.restaurant_register(req)
#     if not result.get('success'):
#         return result
#     return result['data']
...
# ):
#     """Restaurant listesi endpoint - Restaurant ve Admin"""
#     result = await ctrl.list_restaurants()
#     return result['data']
...
#     claims: Dict[str, Any] = Depends(auth_controller.require_roles(["Restaurant", "Admin"]))
# ):
#     """Restaurant profil görüntüleme - Restaurant ve Admin"""
#     return await ctrl.get_restaurant_profile(restaurant_id)
...
#     claims: Dict[str, Any] = Depends(auth_controller.require_roles(["Restaurant", "Admin"]))
# ):
#     """Restaurant profil güncelleme - Restaurant ve Admin"""
#     return await ctrl.update_restaurant_profile(restaurant_id, req)
...
# ):
#     """Restorana kurye atama endpoint"""
#     # Restoran sadece kendine kurye atayabilir (Admin hariç)
...
# ):
#     """Restoranın kuryelerini getir endpoint"""
#     # Restoranlar sadece kendi kuryelerini görebilir (Admin hariç)
#     if "Admin" not in claims.get("roles", []) and restaurant_id != claims.get("user_id"):
#         raise HTTPException(status_code=403, detail="Unauthorized to view couriers for this restaurant")
...
# ):
#     """Restorandan kurye atamasını kaldır endpoint"""
#     # Restoran sadece kendi kuryelerini silebilir (Admin hariç)
#     if "Admin" not in claims.get("roles", []) and restaurant_id != claims.get("user_id"):
#         raise HTTPException(status_code=403, detail="Unauthorized to remove courier from this restaurant")
